...
sshpass $ADMINPWD scp $ADMINUSER@13.68.219.72:/opt/SF5.8/fabric/webapps/livecluster/public_html/register/install/unixengine/DSEngineLinux64.tar.gz ~/
sudo chown -hR  $ADMINUSER /opt;
cd /opt
