...
sshpass $ADMINPWD scp $ADMINUSER@13.68.219.72:/opt/SF5.8/fabric/webapps/livecluster/public_html/register/install/unixengine/DSEngineLinux64.tar.gz ~/ >> /var/log/sfengine.log

sudo chown -hR  $ADMINUSER /opt >> /var/log/sfengine.log;
cd /opt
tar -xvzf ~/DSEngineLinux64.tar.gz >> /var/log/sfengine.log

DSENGINE=/opt/datasynapse/DSEngine
